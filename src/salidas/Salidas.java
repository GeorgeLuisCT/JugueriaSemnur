...
public class Salidas extends javax.swing.JInternalFrame { 
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "PRODUCTO", "CANTIDAD", "PRECIO UNITARIO", "FECHA"
            }
        ) {
        ...
        jLabel1.setText("DESCRIPCIÓN DE LA COMPRA");
        ...
        nuevo.setText("REGISTRAR COMPRA");
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        if (this.tabla.getRowCount() < 1) {
            ...
            if (this.tabla.getSelectedRowCount() < 1) {
                ...
                mp.cantidad.setText(this.tabla.getValueAt(fila, 2).toString());
                mp.precioUnit.setText(this.tabla.getValueAt(fila, 3).toString());
                mp.fecha.setText(this.tabla.getValueAt(fila, 4).toString());

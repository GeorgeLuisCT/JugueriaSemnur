...
import producto.recetas.CrearReceta;
import producto.recetas.SeleccionProducto;

public class RecetaOProducto extends javax.swing.JDialog {

    Timer timer = null;
    TimerTask task;
    int i = 32;

    public RecetaOProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnVentas.setText("SELECCIONAR PRODUCTO");
        ...
        btnListaVentas.setText("CREAR RECETA");
    ...
    private void btnVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentasActionPerformed
        Cerrar();
        SeleccionProducto receta = new SeleccionProducto(new JDialog(), true);
    ...
    private void btnListaVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListaVentasActionPerformed
        Cerrar();
        CrearReceta receta = new CrearReceta(new JDialog(), true);
        receta.nombreReceta.setText("RECETA PARA "+ ModalProductoVentas.nombre.getText());
        receta.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecetaOProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RecetaOProducto dialog = new RecetaOProducto(new JFrame(), true);

...
public class Recetas extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public Recetas(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOMBRE", "DESCRIPCCION", "INGREDIENTES", "RESULTADO"
            }
        ) {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        Opciones.obtenerRecetas(this.buscar.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Recetas(new javax.swing.JDialog(), true).setVisible(true);
            }
        });
    }

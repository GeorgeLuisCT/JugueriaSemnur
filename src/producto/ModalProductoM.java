...
public class ModalProductoM extends javax.swing.JDialog {
    ...
    TimerTask task;
    int i = 32;
public static String NombreJugo;
    /**
    ...
    private void CargarCategorias() {
        ...
        String sqlCategorias = "SELECT nombre FROM categorias";
        try {
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(sqlCategorias);

            tipo.removeAllItems();
 
            while (rs.next()) {
                String nombreCategoria = rs.getString("nombre");
                tipo.addItem(nombreCategoria);
            }
        } catch (SQLException ex) {
            Logger.getLogger(Opciones.class.getName()).log(Level.SEVERE, null, ex);
        }

        stock.setText("");//dejame aqui =)
    }
    ...
    private void registrar() {
        if (this.nombre.getText().equals("") || this.descripcion.getText().equals("")
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                s.setDescripcion(this.descripcion.getText());
                s.setTipo(this.tipo.getSelectedIndex() + 1);
                s.setPrecio(Double.valueOf(this.precio.getText()));
                s.setStock(Double.parseDouble(this.stock.getText()));

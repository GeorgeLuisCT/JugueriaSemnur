...
public class ModalElegir extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnVentas.setText("PRODUCTOS PARA VENTAS");
        ...
        btnListaVentas.setBackground(new java.awt.Color(168, 207, 67));
        btnListaVentas.setForeground(new java.awt.Color(255, 255, 255));
        btnListaVentas.setText("PRODUCTOS PARA COMPRAS");
    ...
    private void btnVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVentasActionPerformed
        this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.productoventas)) {
            PrincipalAdministrador.productoventas = new ProductosVentas();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.productoventas.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.productoventas);
            PrincipalAdministrador.productoventas.show();
        }
    ...
    private void btnListaVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListaVentasActionPerformed
          this.dispose();
        if (PrincipalAdministrador.estacerrado(PrincipalAdministrador.producto)) {
            PrincipalAdministrador.producto = new Productos();
            int width = PrincipalAdministrador.escritorio.getWidth();
            int Height = PrincipalAdministrador.escritorio.getHeight();
            PrincipalAdministrador.producto.setSize(width, Height);
            PrincipalAdministrador.escritorio.add(PrincipalAdministrador.producto);
            PrincipalAdministrador.producto.show();
        }

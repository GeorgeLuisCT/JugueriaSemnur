...
import static principal.PrincipalAdministrador.productoventas;

public class ModalProductoVentas extends  javax.swing.JDialog{
     ...
     */
    public ModalProductoVentas(java.awt.Frame parent, boolean modall) {
        super(parent, modall);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel4.add(descripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, 240, 30));
        ...
        panel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 420, 430));
        ...
        jPanel3.add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 160, 50));
        ...
        jPanel3.add(registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 170, 50));

        id.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        id.setForeground(new java.awt.Color(255, 255, 255));
        id.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        id.setText("id");
        jPanel3.add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 200, 30, -1));

        panel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 340, 459, 250));

        getContentPane().add(panel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 476, 600));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalProductoVentas.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModalProductoVentas dialog = new ModalProductoVentas(new java.awt.Frame(), true);
    ...
    private void registrar() {
        if (this.nombre.getText().equals("") || this.descripcion.getText().equals("")
            ...
            if (this.registrar.getText().equals("GUARDAR")) {
                ...
                int opcion = producto.OpcionesVentas.actualizar(s);
                if (opcion != 0) {
                    String fila = this.id.getText();
                    OpcionesVentas.listar("");
                    ProductosVentas.seleccionaFila(fila);
                ...
                RecetaOProducto sa = new RecetaOProducto(new JFrame(), true);
                sa.setVisible(true);
            }
        }
    }

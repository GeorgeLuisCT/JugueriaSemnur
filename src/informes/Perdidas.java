...
public class Perdidas extends javax.swing.JDialog {

    
    public Perdidas(javax.swing.JDialog parent, boolean modal) {
          super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "FECHA", "PRODUCTO", "CANTIDAD", "MOTIVO"
            }
        ) {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        Opciones.buscarPerdidas(this.buscar.getText(), tabla);
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
         ModalDescompuestos mp = new ModalDescompuestos(new JFrame(), true);
                mp.titulo.setText("CREAR");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Perdidas(new javax.swing.JDialog(), true).setVisible(true);
            }
        });
    }

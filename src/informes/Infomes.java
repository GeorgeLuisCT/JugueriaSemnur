...
public class Infomes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        modificar1.setText("GESTIONAR PERDIDAS");
        ...
        eliminar.setText("GRAFICA SEMANAL");
        ...
        eliminarTodo.setText("GRAFICA MENSUAL");
    ...
    private void eliminarTodoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarTodoActionPerformed
       Opciones.obtenerInformeMensualGrafico();
    ...
    private void nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoActionPerformed
        ...
        // Cambiar la cantidad de columnas y los nombres de los encabezados
        String[] newColumnNames = {"CODIGO", "FECHA DE INICIO", "FECHA DE FIN", "TOTAL EN VENTAS", "TOTAL EN COMPRAS", "PERDIDAS", "GANANCIAS"};
        model.setColumnIdentifiers(newColumnNames);
        
        Opciones.obtenerInformeSemanal("",tabla);
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tabla.getModel();
        // Cambiar la cantidad de columnas y los nombres de los encabezados
        String[] newColumnNames = {"CODIGO", "MES", "AÑO", "TOTAL EN VENTAS", "TOTAL EN COMPRAS", "PERDIDAS", "GANANCIAS"};
        model.setColumnIdentifiers(newColumnNames);
        
          Opciones.obtenerInformeMensual("",tabla);
    }//GEN-LAST:event_modificarActionPerformed

    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        Opciones.obtenerInformeSemanalGrafico();
    }//GEN-LAST:event_eliminarActionPerformed

    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
        if (mensual) {
            Opciones.obtenerInformeMensual(buscar.getText(),tabla);
        }else{
            Opciones.obtenerInformeSemanal(buscar.getText(),tabla);
        }
    ...
    private void modificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificar1ActionPerformed
            Perdidas receta = new Perdidas(new javax.swing.JDialog(), true);

...
public class ListaVentas extends javax.swing.JInternalFrame {
    ...
    public ListaVentas() {
        ...
        jScrollPane1.getViewport().setBackground(new java.awt.Color(168,207,67));
        jScrollPane1.getViewport().setBackground(new java.awt.Color(255,255,255));
        jScrollPane1.getVerticalScrollBar().setUI(new MyScrollbarUI());
        jScrollPane1.getHorizontalScrollBar().setUI(new MyScrollbarUI());

        CorteCajaDAO.consultarVentas(tabla);
   ...
   //     Opciones.corteCaja();
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "COD", "FECHA", "NOMBRE DEL TRABAJADOR", "TOTAL", "PRODUCTOS"
            }
        ) {
    ...
    private void buscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarKeyReleased
       CorteCajaDAO.mostrarCortesCaja(buscar.getText());
    ...
    private void corteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_corteActionPerformed
        ...
        String[] newColumnNames = {"CODIGO", "FECHA", "HORA", "INGRESOS", "EGRESOS", "TOTAL EFECTIVO", "DIFERENCIA"};
        model.setColumnIdentifiers(newColumnNames);
        

         Date fechaActual = new Date();
        CorteCajaDAO.generarCorteCaja(fechaActual);
        CorteCajaDAO.mostrarCortesCaja("");

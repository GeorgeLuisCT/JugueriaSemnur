...
public class WarningAlertP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        aceptar.setBackground(new java.awt.Color(168, 207, 67));
    ...
    private void eliminarRegistro() {
        switch (tablaEliminar) {
            case "productos":
                int elimina = producto.Opciones.eliminar(Integer.parseInt(this.id.getText()));
                if (elimina != 0) {
                    Opciones.listar("");
                    this.dispose();
                ...
                break;
            case "productoVentas":
                int eliminaV = producto.OpcionesVentas.eliminar(Integer.parseInt(this.id.getText()));
                if (eliminaV != 0) {
                ...
                break;
                case "categorias":
                int eliminaC = producto.categorias.Opciones.eliminarCategoria(Integer.parseInt(this.id.getText()));
                if (eliminaC != 0) {
                    producto.categorias.Opciones.listarCategorias("");
                    this.dispose();
                    SuccessAlert sa = new SuccessAlert(new JFrame(), true);
                    sa.titulo.setText("¡HECHO!");
                    sa.msj.setText("SE HA ELIMINADO UN");
